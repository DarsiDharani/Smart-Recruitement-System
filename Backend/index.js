...
app.post('/api/mock-interview', async (req, res) => {
    try {
        ...
        const prompt = `Generate exactly 1 technical interview question and exactly 1 HR interview question for
         a ${role} with ${experience} years of experience. Respond only with the two questions in plain text. Do not include any labels like "Technical Question" or "HR Question". Just list them one after the other.`;
